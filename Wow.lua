playerRoles = {
    ["PRIMARY"] = {"MAIN TANK", "HEALER 1", "OFF TANK", "HEALER 2", "HEALER 3", "HEALER 4", "HEALER 5", "HEROISMO"},
    ...
    ["SKILL"] = {"DESACTIVAR TRAMPA", "SECRETOS DEL OFICIO", "REDIRECCION", "TRAMPA DE ESCARCHA", "COLERA SAGRADA",
