playerRoles = {
    ["PRIMARIO"] = {"MAIN TANK", "HEALER 1", "OFF TANK", "HEALER 2", "HEALER 3", "HEALER 4", "HEALER 5"},
    ...
    ["SKILL"] = {"HEROISMO", "DESACTIVAR TRAMPA", "SECRETOS DEL OFICIO", "REDIRECCION", "TRAMPA DE ESCARCHA", "COLERA SAGRADA",
                 ...
                 "ENCADENAR NO MUERTO"},
    ["SECUNDARIO"] = {"RESUCITAR CAIDOS", "RITUAL DE INVOCACION", "RITUAL DE REFRIGERIO", "PIEDRA DE ALMA", "TOTEM DE NEXO TERRESTRE"},
