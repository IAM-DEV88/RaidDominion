...
raidRules = {
	...
	["ICC 25 N"] = {
		...
		"TESTAMENTO: top5 daño en Panza cerrado + 5% en bestias. Rollean warrior fury, dk profano/escarcha, pícaro combate y druida feral, hunter punteria, mejora. // OBJETO: top5 cerrado daño en Panza + 3% en bestias.",
		"FILACTERIA: top3 cerrado daño en Profe + 10% en mocos. // COLMILLO: prioridad tanques activos en su rol, luego el resto. // RESERVADOS: Fragmentos, Sangres, Items no ligados y Saros.",
		"ARMAS LK: top10 daño en LK + 5% en Valkyrs y top3 conteo de sanacion en LK. // Un abalorio, Un arma, Dos marcas por raid. Un ítem por main(excepto tankes), sin limite por dual. Marcas tambien por dual.",
...
raidMechanics = {
	...
	["LIBRA"] = {
		"TANQUES sobre escaleras atentos a marcas // Cuerpo a cuerpo bajo escaleras // Ranged a /range 12 evitan marcas // Trampa de Escarcha a mi señal // Marcados no atacan bestias // HEROISMO a mi señal",
...
auras = {
	...
	{ name = "Aura de Resistencia al Fuego", icon = "Interface\\Icons\\Spell_Fire_SealOfFire" },
	{ name = "Aura de Resistencia a la Escarcha", icon = "Interface\\Icons\\Spell_Frost_WizardMark" },
	{ name = "Aura de Resistencia a las Sombras", icon = "Interface\\Icons\\Spell_Shadow_SealOfKings" },
	...
	{ name = "Tótem Tremor", icon = "Interface\\Icons\\Spell_Nature_TremorTotem" },
	...
	{ name = "Aspecto del Dragón", icon = "Interface\\Icons\\Ability_Hunter_AspectOfTheViper" },
	...
	{ name = "Zona antimagia", icon = "Interface\\Icons\\Spell_DeathKnight_AntiMagicZone" },
	{ name = "Cuerno de invierno", icon = "Interface\\Icons\\INV_Misc_Horn_02" },
...
guildRules = {
	...
	["NOTA PUBLICA Y DE OFICIAL"] = {
		"» Envíen su función y GS por susurro al GM/Alter/Oficial para ascender.",
		"→ ROSTER PUBLICO: https://colmillo.netlify.app/roster",
	...
	-- RAIDS
	["RAIDS DE HERMANDAD"] = {
		"» Registren su asistencia a los core disponibles.",
		"→ RAIDS PROGRAMADOS: https://colmillo.netlify.app/raids",
		"» Deben tener registrado su función y GS para poder hacer el registro.",
	},
	-- BANCO
	["PRIMERA PESTAÑA DEL BANCO"] = {
		"→ Se reciben donaciones de oro, equipamiento o farm lvl 74+.",
		"→ BOEs, consumibles, hebillas, armaduras, etc. son sorteados.",
		"→ Sorteos diarios desde Iniciado hasta el rango máximo.",
		"» Envíen su función y GS por susurro al GM/Alter/Oficial para ascender.",
	},
	-- BOES
	["BOES DEL BANCO EN REMATE"] = {
		"→ Se recibe oro, equipamiento o farm lvl 74+ como parte de pago.",
		"→ BOEs, hebillas, etc. con 30% de descuento.",
		"» Segun precio en subasta.",
	},
	-- BOES
	["SORTEO DE NOVIEMBRE"] = {
		"→ El 30 de Noviembre se sortea [Gargantilla carmesí de la Reina de Sangre] x1.",
		"» Para jugadores con funcion y gs registrados, y añadidos en whatsapp.",
		"→ https://chat.whatsapp.com/BahYOaTMZfHIwYQGey3G91",
	},
}
