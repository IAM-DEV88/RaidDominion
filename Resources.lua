...
raidRules = {
    -- Fin de bienvenida a la hermandad
    ["LA CAMARA DE ARCHAVON"] = {"BOTIN => PVE: Por función MAIN // PVP: Por clase"},
    ["RAID DOMINION"] = {"Descarga y uso del addon // Portal: https://raid-dominion.netlify.app/"},
    ...
    ["BOTIN"] =  {"No DC = No Botin // Se rollea 20 minutos antes del ligado del item o al dar Raid Off en el orden que fue obtenido."},
...
mainOptions = {"Habilidades principales", "Roles principales", "BUFFs", "Roles secundarios", "RaidDominion", "Hermandad"}
